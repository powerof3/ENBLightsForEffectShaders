...
namespace ColorSpace {
	...
	double Cie2000Comparison::Compare(IColorSpace *a, IColorSpace *b) {
		...
		double h1 = fmod(atan2(lab_a.b, a1p) + double(2*M_PI), double(2*M_PI));
		double h2 = fmod(atan2(lab_b.b, a2p) + double(2*M_PI), double(2*M_PI));
